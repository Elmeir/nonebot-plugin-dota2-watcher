...
| `/添加刀塔战队 [队名或 team_id 或 CN]`   | 订阅战队，其登记名单变动（成员加入 / 离开）时自动播报；`CN` 一键订阅全部中国战队 | 任意  |
...
>
> 战队订阅支持队名、官方缩写或 team_id：`/添加刀塔战队 XG`、`/添加刀塔战队 Team Liquid`、`/添加刀塔战队 8261500` 均可；`/添加刀塔战队 CN` 一键订阅全部中国战队。
